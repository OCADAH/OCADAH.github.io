var kitty = {
    ...
    threats: null,
    meow: function (){ // a fucntion contained as a key value pair of an object is called a method
        return "meow";
...
console.log(typeof kitty.future++); // results in a type number with value NaN which is not a number
...
x.z = function(){}; // method
x.z(); // invoke the z method method and returns undefined unless modified
